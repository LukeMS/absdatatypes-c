...
/*************************************************************//**
 * ListElmt, ListElmt_: structure for linked list elements.
 ****************************************************************/
...
/*************************************************************//**
 * List, List_: structure for linked lists.
 ****************************************************************/
...
/*************************************************************//**
 * list_init: Initializes the linked list specified by `list`
 *
...
/*************************************************************//**
 * list_destroy: Destroys the linked list specified by `list`.
 *
 ...
 * `destroy` to list_init once for each element as it is removed, provided
...
/*************************************************************//**
 * list_ins_next: Inserts an element just after `element` on `list`.
 *
...
/*************************************************************//**
 * list_rem_next: Removes the element just after `element` on `list`.
 *
...
/*************************************************************//**
 * list_size: evaluates to the number of elements on `list`.
 *
 * \param *list pointer to a `List` struct
 * Complexity: O(1).
 *
...
/*************************************************************//**
 * list_head: evaluates to the element at the head of `list`.
 *
 * \param *list pointer to a `List` struct
 * Complexity: O(1).
 *
...
/*************************************************************//**
 * list_tail: evaluates to the element at the tail of `list`
 *
 * \param *list pointer to a `List` struct
 * Complexity: O(1).
 *
...
/*************************************************************//**
 * list_is_head: determines whether `element` is at the head of `list`.
 *
 * \param *list pointer to a `List` struct
...
/*************************************************************//**
 * list_is_tail: determines whether `element` is at the tail of `list`.
 *
 * \param *list pointer to a `List` struct
 * \param *element pointer to the `ListElmt` to be checked
 *
...
/*************************************************************//**
 * list_data: evaluates to the data stored on `element`
 *
 * \param *element pointer to the `ListElmt` to be checked
 *
...
/*************************************************************//**
 * list_next: evaluates to the element following `element`.
 *
